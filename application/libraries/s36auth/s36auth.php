...
class S36Auth {
    ...
    // returns static::$user that contains the
    // user, company, and auth assignment data of the authed user.
    ...
    // gets the company data of the authed user.
    ...
    // gets the site data of the authed user.
